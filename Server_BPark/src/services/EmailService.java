...
public class EmailService {
	 ...
	 * 
	 * Initializes the service responsible for sending emails related to the BPARK
	 * system.
	 */
	public EmailService() {
		// Default constructor
	...
	/** Gmail address used to send support or notification emails. */
	private static final String GMAIL_USERNAME = "idopo25@gmail.com";

	/** App-specific password for the Gmail account used to send emails. */
	private static final String GMAIL_APP_PASSWORD = "kylk wqxz kquw vccf";

	/** Customer support phone number displayed in emails or UI. */
	private static final String SUPPORT_PHONE = "1-800-800-123";

	/** Customer support email address used for contact or feedback. */
	private static final String SUPPORT_EMAIL = "support@bpark.com";

	/** Name of the company shown in communication and branding. */
	private static final String COMPANY_NAME = "BPARK";

	/** URL pointing to the company logo used in UI or emails. */
	...
	public enum NotificationType {
		/**
		 * Notification for late pickup beyond reserved time.
		 */
		LATE_PICKUP,
		...
		/**
		 * Confirmation of a successful parking reservation.
		 */
		...
		/**
		 * Email to help the user recover their parking code.
		 */
		PARKING_CODE_RECOVERY,

		/**
		 * Confirmation that the parking time was extended.
		 */
		EXTENSION_CONFIRMATION,

		/**
		 * Notification that the parking time has expired.
		 */
		PARKING_EXPIRED,

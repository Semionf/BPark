...
/**
 * Represents a parking order/session in the ParkB system. Contains information
 * about entry, exit, and parking details.
 */
public class ParkingOrder implements Serializable {

	/** Identifier for Serializable class version control. */
	...
	/**
	 * Type of the order - either "ordered" (reservation) or "not ordered"
	 * (immediate).
	 */
	...
	/**
	 * Returns the estimated start time for the parking session.
	 *
	...
	/**
	 * Sets the estimated start time for the parking session.
	 *
	 * @param estimatedStartTime the estimated start time to set
	 */
	...
	/**
	 * Calculates the total parking duration in minutes. If exit time is null,
	 * calculates duration from entry time until now.
	 *
	...
	/**
	 * Returns the parking duration formatted as "X hours, Y minutes".
	 *
	...
	/**
	 * Checks if the vehicle is currently parked (i.e., no exit time and status is
	 * "Active").
	 *

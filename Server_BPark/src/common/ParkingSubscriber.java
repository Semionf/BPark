...
/**
 * Represents a parking subscriber in the ParkB system. Contains subscriber
 * information such as ID, contact details, car information, user type, and
 * parking order history.
 */
public class ParkingSubscriber implements Serializable {
	 ...
	 */
	public ParkingSubscriber(int subscriberID, String subscriberCode, String firstName, String phoneNumber,
			String email, String carNumber, String userType) {
	...
	/**
	 * Returns a string representation of the ParkingSubscriber, including key
	 * fields but excluding parking history for brevity.
	 *
	 * @return formatted string describing the subscriber
	 */
	@Override
	public String toString() {
		return "ParkingSubscriber{" + "subscriberID=" + subscriberID + ", subscriberCode='" + subscriberCode + '\''
				+ ", firstName='" + firstName + '\'' + ", phoneNumber='" + phoneNumber + '\'' + ", email='" + email
				+ '\'' + ", carNumber='" + carNumber + '\'' + ", userType='" + userType + '\'' + '}';
	}
}
